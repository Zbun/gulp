...
if (needCLodop()) {
  ...
  oscript8.src = 'http://localhost:8000/CLodopfuncs.js?priority=1';
...
function getLodop(oOBJECT, oEMBED) {
  ...
  var strCLodopInstall = htmlClose + '<div>CLodop云打印服务(localhost本地)未安装启动!点击这里<a href="/dist/files/CLodop_Setup_for_Win32NT.exe" style="color:#1c8bcc" target="_self">执行安装</a>,安装后请刷新页面。</div>';
  var strCLodopUpdate = htmlClose + '<div>CLodop云打印服务需升级!点击这里<a href="/dist/files/CLodop_Setup_for_Win32NT.exe" style="color:#1c8bcc" target="_self">执行升级</a>,升级后请刷新页面。</div>';
  var LODOP;
  var tempDiv = document.createElement('div');
  tempDiv.id = 'NOLODOPTIPSONTOP';
  tempDiv.setAttribute('style', 'position:relative;z-index:19980;background:#eee;color:#555;line-height:40px;');
  try {
