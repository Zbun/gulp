          ...
          <table class="table table-bordered  text-center">
            ...
            <tfoot>
              ...
              <tr class="noborder-lr">
                ...
                <td style="padding:5px 0;">
                  <p class="bg-currency text-right text-nowrap p10">
                    应收金额：<em class="font-bigger text-bold text-warning">{{dataIn.datalist.FinalPrice|currency}}</em>
                  </p>
                </td>
                <td></td>
              </tr>
            ...
            <tbody>
              <tr v-for="item of dataIn.datalist.Details">
                ...
                <td>{{item.ProCount}}</td>
                <td v-if="item.ProType==1">
                  <p class="text-nowrap text-right">{{(item.ProPrice * item.ProCount)|currency}}</p>
                </td>
                <td v-else>/</td>
