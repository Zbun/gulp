<template>
  <div>
    ...
    <scan-sn :show.sync="isShowScanSn" pop-title="入库串号扫描" :code="curCode" @on-after-submit="dispatchScanSn()" :store-id="curStoreId" auto-match="1" is-by-standard="1" :api-list="rightsApi"></scan-sn>
  </div>
</template>
<script>
