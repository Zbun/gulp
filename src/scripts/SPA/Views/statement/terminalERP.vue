<template>
  <div class="main">
    <h2 class="content-title">渠道进销存</h2>
      ...
      <table class="table text-center table-hover table-odd table-bordered datalist">
        <thead>
          <tr>
            ...
            <th style="width:120px;">业务员</th>
            <th style="width:120px;">区域</th>
            <th style="width:100px;">期初</th>
            <th style="width:100px;">累计采购</th>
            <th style="width:100px;">累计零售</th>
            <th style="width:100px;">结存</th>
          </tr>
        </thead>
        <tfoot v-show="dataIn.inited&&dataIn.dataTable.length>0">
          <tr>
            ...
            <td class="text-nowrap">
              <b>{{dataIn.arrDataTotal.StartCount}}</b>
            </td>
            <td class="text-nowrap">
              <b>{{dataIn.arrDataTotal.PurchaseCount}}</b>
            </td>
            <td class="text-nowrap">
              <b>{{dataIn.arrDataTotal.RetailCount}}</b>
            </td>
            <td class="text-nowrap">
              <b>{{dataIn.arrDataTotal.EndCount}}</b>
            </td>
          </tr>
        </tfoot>
        <tbody>
          <tr v-for="item of dataIn.dataTable">
            ...
            <td>
              <p class="text-nowrap">{{item.Salesman}}</p>
            </td>
            <td>
              <p class="text-nowrap" :title="item.AreaName">{{item.AreaName}}</p>
            </td>
            <td>
              <p class="text-nowrap">
                {{item.StartCount}}
            ...
            <td>
              <p class="text-nowrap">{{item.EndCount}}</p>
            </td>
          </tr>
        </tbody>
