<template>
  <div class="main">
    <h2 class="content-title">库存分布</h2>
        ...
        <table class="table text-center table-hover table-odd table-bordered datalist table-detail">
          ...
          <tbody>
            <tr v-for="item of dataIn.dataTable">
              ...
              <td>
                <p class="text-left pl5" :title="item.ProName">{{item.ProName}}</p>
              </td>
              <template v-for="item2 in item.Details">
                ...
                <td>
                  <p class="text-nowrap">{{item2.ProOnTran}}</p>
                </td>
                <td>
                  <p class="text-nowrap">{{item2.ProOnBorrow}}</p>
                </td>
              </template>
            </tr>
          </tbody>
