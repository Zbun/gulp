<template>
  <div class="main" v-cloak>
            ...
            <tbody>
              ...
              <tr>
                <td>
                  ...
                  <span class="content">
                    {{dataIn.datalist.PayDeadLine|date}}
                  </span>
                </td>
                <td>
    ...
    <scan-sn :show.sync="isShowScanSn" pop-title="入库串号扫描" :code="curCode" @on-after-submit="dispatchScanSn()" :store-id="dataIn.datalist.StoreId" is-by-standard="1" :api-list="scanSNAPIList" is-goback="1"></scan-sn>
  </div>
</template>
<script>
...
export default {
  data() {
      return {
        ...
        scanSNAPIList: {
          ready: '/Api/PO/PCImeiReady',
          submit: '/Api/PO/ReceivingInsert',
