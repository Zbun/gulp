    ...
    <div class="content-field">
      <div>
        <div class="search clearfix mt20">
          ...
          <input type="search" class="com-ipt width" placeholder="输入关键字" v-model="dataOut.search.SupplierName" maxlength="50" @keydown.enter="initPageData(1)">
          </span>
          <span class="ml20">
...
export default {
  props: {
    loadedFirst: false,
    refresh: false,
    refreshForeshow: false,
  },
  data() {
    return {
      pageindex: 1,
      isShowLibraryInForeshow: false,
      curPCode: '',
      APILIST: {
  ...
  methods: {
    initPageData(pageindex = 1) {
      ...
      fetchData({
        ...
        callback(data) {
          // console.log(data);
          if (data.Data.length == 0 && me.pageindex > 1) {
