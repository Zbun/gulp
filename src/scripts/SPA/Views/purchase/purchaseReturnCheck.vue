          ...
          <table class="table table-bordered  text-center">
            ...
            <tfoot>
              <tr>
                ...
                <td><b>{{dataIn.datalist.TotalPrice|currency}}</b></td>
                <td></td>
              </tr>
            </tfoot>
            <tbody>
              <tr v-for="item of dataIn.datalist.Details">
                ...
                <td>
                  <p class="text-nowrap">{{item.ProPrice|currency}}</p>
                </td>
                <td>{{item.ProCount}}</td>
                <td>
                  <p class="text-nowrap">{{(item.ProPrice * item.ProCount)|currency}}</p>
                </td>
...
export default {
  data() {
    ...
    methods: {
      initPageData() {
        var me = this;
        this.curCode = me.$route.params.precCode;
        fetchData({
