    ...
    <div class="content-field">
      <div class="content-large w70p">
        ...
        <div class="invoices-detail  set w6em" style="padding:30px 60px;margin:10px 0;">
          <h2 class="super-big-title"><span class="text">返 利</span></h2>
          <dl class="item">
          ...
          <dl class=" set item">
            <dt class="title">
              <dd class="content set p20 border-box pl30" style="margin-left:3.8em">
                <dl class="item">
                  <dt class="title">
                    <b>账户余额：</b><span v-if="curCode.length>0"> {{editInfo.RebateAmount}} </span><span v-else> {{computedRemain}} </span>元
                  </dt>
                </dl>
                <dl class="item">
                  <dt class="title">
                ...
                <dl class="item">
                  ...
                  <dd class="content">
                    <input type="number" min=0 max=100 v-model="editInfo.CanUsedRate|posPercentIntegerIn" class="com-ipt small" datalivate="integer required" placeholder="输入比例"> %
                  </dd>
                </dl>
              </dd>
            </dt>
