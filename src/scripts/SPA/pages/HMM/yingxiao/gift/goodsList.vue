        ...
        <div class="body">
          <div class="content" style="width:800px">
            <div class="search-box clearfix">
              <input type="search" placeholder="请输入SKU名称" class="com-ipt ipt-search ml5" v-model="dataOut.search.Key" @keydown.enter="initPageData(1)">
...
export default {
  ...
  methods: {
    initPageData(pageIndex) {
      ...
      para.pageSize = 7;
      fetchData({
        API: '/api/Activity/SGetGiftSkuSearchList',
        para,
        callback: data => {
    ...
    choosePro(item) { //选择商品
      ...
      objTemp._isIn = false; //默认写入一个是否当前时间参加过活动的字段标记
