<template>
  <div style="display:inline-block">
    <span class="select-box" @click="selectOrder()">
      <input type="text" :title="editInfo.RInvoiceCode" placeholder="选择销售退货入库单" readonly v-model="editInfo.RInvoiceCode">
      <i class="icon" title="点击选择销售退货入库单编号"></i>
    </span>
    <div class="popup" v-if="show">
      <div class="content">
        <h2 class="title">
          <a href="javascript:;" class="close" title="关闭" @click="onCancel_Click">&times;</a>选择销售退货入库单</h2>
        <div class="body">
...
export default {
  ...
  data() {
    return {
      ...
      objCurItem: {},
      APILIST: {
        LIST: 'api/RInvoice/List',
        PREVIEW: '/API/RInvoice/Preview', //预览
      },
      dataIn: {
        inited: false,
        dataTable: {}
  ...
  methods: {
    ...
    onSubmit_Click() {
      ...
      objTemp.RInvoiceCode = objTemp.Code;
      delete objTemp.Code;
