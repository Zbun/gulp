<template>
  <div style="display:inline-block">
    <span class="select-box" @click="selectOrder()">
      <input type="text" :title="editInfo.InvoiceCode" placeholder="选择出库单" readonly v-model="editInfo.InvoiceCode">
      <i class="icon" title="点击选择出库单编号"></i>
    </span>
    <div class="popup" v-if="show">
      <div class="content">
        <h2 class="title">
          <a href="javascript:;" class="close" title="关闭" @click="onCancel_Click">&times;</a>选择出库单</h2>
        <div class="body">
            ...
            <div class="bg-muted border-box mt-1 p10 pb20 pl20 pr20 bg-body" v-show="isItemClick">
              <div class="ml10 mb10" style="max-width:80%">
                <div class="clearfix align-btn">
                  <b>
                    <span class="font-small">出库单号：{{objCurItem.Code}}</span>
                  </b>
                </div>
                <table class="table bg-white text-center border-box">
                  <thead>
                    <tr style="border-bottom:1px solid #eaeaea;">
                      ...
                      <td class="bg-muted" style="width:110px;">出库数量</td>
...
export default {
  ...
  data() {
    return {
      ...
      APILIST: {
        ...
        PREVIEW: '/API/Invoice/Preview', //预览
      },
      dataIn: {
        inited: false,
        dataTable: {}
  ...
  methods: {
    ...
    onSubmit_Click() {
      ...
      objTemp.InvoiceCode = objTemp.Code;
      delete objTemp.Code;
