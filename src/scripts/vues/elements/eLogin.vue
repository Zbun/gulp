<template>
  <div id="login-box" v-show="isJudged">
    ...
    <section class="content" :style="{backgroundColor: bgColor}">
      <div class="container" :style="{backgroundImage: 'url(' + bgImage + ')'}">
        <form class="form-login" onsubmit="return false;">
          <p class="titForm">
            账户登录
            <a href="/apply.html?/#/reg">立即注册</a>
            <!-- <router-link class="item" :to="{path:'apply.htm/reg'}">立即注冊</router-link> -->
          </p>
          <p>
            <input type="search" class="com-ipt large userName" @input="ipt_input()" placeholder="请输入手机号" v-model="userName" data-validate="required phone">
          </p>
          <p>
          ...
          <p class="for_pwd">
            <span>
              <a href="apply.html?/#/findPwd">忘记密码</a>
            </span>
          </p>
    ...
    <div class="login-footer">
      <div class="container">
        <ul class="ysFooter clearfix">
          <li>
            <i class="bg-icon"></i>厂家直营
            <span>低价好货</span>
          </li>
          <li>
            <i class="bg-icon bg-icon1"></i>厂家直营
            <span>低价好货</span>
          </li>
          <li>
            <i class="bg-icon bg-icon2"></i>厂家直营
            <span>低价好货</span>
          </li>
          <li>
            <i class="bg-icon bg-icon3"></i>厂家直营
            <span>低价好货</span>
          </li>
        </ul>
        <ul class="linkFooter clearfix" style="border:0">
          <li>
            <p>
              商家服务
            </p>
          ...
          <li>
            <p>
              服务热线
              <br> 400-017-6908
              <p style="color:#999;">（周一至周日8：00-19：00）</p>
            </p>
            <p>
          ...
          <li>
            ...
            <p>
              <span class="bg-icon sjrz-icon"></span>商家认证
            </p>
            <p>
              <span class="bg-icon jyaq-icon"></span>交易安全
            </p>
          </li>
          <li>
            <p>
        ...
        <div class="wzsm">
          <p>公司名:慧聪云商（佛山）网络科技有限公司|地址：广东顺德慧聪家电城4楼|电话：400-017-6908 Copyright © 2016 - 2017 家电汇 版权所有│粤ICP备16088065号</p>
          <div class="webIink">
            <div>
              <span class="bg-icon fonter-icon1"></span>
              <a href=""> 经营性网站备案信息 </a>
            </div>
            <div>
              <span class="bg-icon fonter-icon2"></span>
              <a href="">网站警察提醒您</a>
            </div>
            <div>
              <span class="bg-icon fonter-icon3"></span>
              <a href="">中国互联网举报中心
              </a>
            </div>
            <div>
              <span class="bg-icon fonter-icon4"></span>
              <a href=""> 网络举报APP下载</a>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    initPage() {
      let bgImage = "/dist/images/loginBanner.jpg";
      let bgColor = "#f22536";
    ...
    login_Click(refresh, e) {
      ...
      this.isSending = true;
      fetchData({
        API: "api/UserAuth/LoginSupplier",
        target: e.target,
        hideTips: true,
        hideLoading: !!refresh,
        para,
        ...
        callback(data) {
          ...
          //     (data.EntryType == 2 || data.EntryType == 1)
          //   ) {
          //     //跳转到企业审核进度界面
          //     location =
          //       "apply.html?/#/cAuditProgress?userType=" +
